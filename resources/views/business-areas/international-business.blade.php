...
<section class="w-full">
    <div class="w-full h-96 lg:h-[518px] relative overflow-hidden">
        <img src="{{ asset('banner/international-bussiness.png') }}" alt="" srcset=""
        ...
        <div class="w-full lg:w-1/2 h-full absolute top-0 left-0 z-20 flex justify-center items-end lg:items-center">
            <div class="w-full md:w-[550px] ">
                <h5 class=" text-2xl md:text-3xl xl:text-5xl text-orange-500  font-poppins px-2 mb-10">Global Expertise
                    Local Impact in Agrochemicals</h5>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-7">
        ...
        <div class="flex items-center justify-center">
            <div class="lg:w-[501px] px-4 lg:px-0">
                <h2 class="text-3xl md:text-[40px] md:leading-[50px] font-inter">Customized Solutions for Tropical
                    Agriculture</h2>

                <p class="text-base text-gray-600 font-inter my-7">Our agrochemicals are specifically designed to thrive
                    in tropical climates. They effectively combat local pests, ensuring robust crop yields.</p>
                <div class="grid lg:grid-cols-2 gap-5">
                    <div class="rounded-lg  px-5 py-10">
                        ...
                        <p class="text-sm ">Formulations tailored to meet the unique challenges of tropical agriculture.
                        </p>
                    </div>
                    <div class="rounded-lg  px-5 py-10">
                        <img src="{{ asset('icon/rings.png') }}" alt="" srcset="" class="mb-5 w-5">
                        <h5 class="text-lg  mb-3">Pest Resistance</h5>
                        <p class="text-sm ">Advanced solutions designed to protect crops from prevalent pests in
                            tropical regions</p>
                    </div>
                </div>
                <!-- <div class="grid lg:grid-cols-2 gap-5">
...
<section class="w-full my-16">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-7">
        <div class="flex items-center justify-center order-2 lg:order-1">
            <div class="lg:w-[501px] px-4 lg:px-0">
                <h2 class="text-3xl md:text-[40px] md:leading-[50px] font-inter">Streamlined Logistics for Global Reach
                </h2>

                <p class="text-base text-gray-600 font-inter my-7">Our strategic logistics hubs ensure that your
                    agrochemical needs are met swiftly and effectively. With a focus on speed and reliability, we
                    deliver the products you need when you need them.</p>
                <div class="grid lg:grid-cols-2 gap-5">
                    <div class="rounded-lg  px-5 py-10">
                        <img src="{{ asset('icon/rings.png') }}" alt="" srcset="" class="mb-5 w-5">
      ...
      <div class="rounded-lg bg-orange-100 px-5 py-10">
        ...
        <div class="px-2 sm:px-3 lg:px-0 order-1 lg:order-2"><img src="{{ asset('banner/agrochemical.png') }}" alt="" srcset=""
                class="max-h-[80vh] w-full object-cover rounded-md lg:rounded-e-none lg:rounded-s-md"></div>
    </div>
</section>
<section class="w-full my-16">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-7">
        ...
        <div class="flex items-center justify-center">
            <div class="lg:w-[501px] px-4 lg:px-0">
                <h2 class="text-3xl md:text-[40px] md:leading-[50px] font-inter">Partnering for Agricultural Progress
                    Worldwide</h2>

                <p class="text-base text-gray-600 font-inter my-7">We work closely with global agricultural NGOs to
                    enhance farming practices and promote sustainable agriculture. Our partnerships ensure that
                    innovative solutions reach the farmers who need them most.</p>
...
<section class="w-full bg-cover bg-no-repeat h-[490px] mt-16"
    ...
    <div class="w-10/12 m-auto flex flex-wrap justify-between">
        <div>
            <h5 class="text-3xl lg:text-[40px] md:leading-[45px] font-poppins md:w-[500px] lg:w-[600px] mb-3">Explore
                Our Global Solutions</h5>
            <p class="text-gray-600 mb-5 md:w-[500px]">Trusted agrochemicals for healthier crops worldwide.</p>
        </div>
        <div class="mt-5"><a href=" https://demokalyani.skilladders.com/view/business/institution.html"
