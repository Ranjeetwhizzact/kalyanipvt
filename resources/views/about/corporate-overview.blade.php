        ...
        <div class="relative z-20 flex flex-col items-center w-full">
            ...
            <div class="mt-10 flex flex-col items-center">
                <p class="text-xs font-medium text-gray-600 mb-2 font-inter">
                    {{ $footerSetting?->youtube_label ?? 'For more Video visit our YouTube Channel' }}
                </p>
                <a href="{{ $footerSetting?->youtube_url ?? '#' }}" class="flex gap-4 items-center group" target="_blank">
                    <i class="ri-youtube-fill text-red-600 text-5xl transition-transform group-hover:scale-110"></i>
                    <div class="border rounded-full px-6 py-2 flex items-center gap-4 bg-white shadow-sm hover:shadow-md transition-all">
                        <span class="font-inter font-medium text-sm">{{ $footerSetting?->youtube_channel_name ?? '' }}</span>
