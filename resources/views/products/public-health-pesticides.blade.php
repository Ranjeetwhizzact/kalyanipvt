            ...
            <a href="{{route('product.agro.chemicals')}}"
                ...
                <div>
                    <img class="m-auto w-10 h-10 lg:w-14 duration-300 object-contain group-hover:invert group-hover:brightness-0"
                        src="{{asset('categoryicon/1743166977agroicon.png')}}"
                        alt="Main Product" loading="lazy">
                    <div class="w-20 lg:w-28 whitespace-normal block">
                        <h3 class="font-medium text-xs sm:text-sm md:text-base text-center group-hover:text-white">
                            AgroChemicals
                        </h3>
                ...
                <div>
                    <img class="m-auto w-10 h-10 lg:w-14 duration-300 object-contain invert brightness-0"
                        src="{{asset('categoryicon/1743230429public_health.png')}}"
                        alt="Main Product" loading="lazy">
                    <div class="w-20 lg:w-28 whitespace-normal block">
                ...
                <div>
                    <img class="m-auto w-10 h-10 lg:w-14 duration-300 object-contain group-hover:invert group-hover:brightness-0"
                        src="{{asset('categoryicon/1750848005images__1_-removebg-preview.png')}}"
                        alt="Main Product" loading="lazy">
                    <div class="w-20 lg:w-28 whitespace-normal block">
                        <h3 class="font-medium text-xs sm:text-sm md:text-base text-center group-hover:text-white">
                            Export Zone
    ...
    <div class="flex max-sm:flex-wrap justify-center bg-gray-200">
        <div class="w-[50%] max-sm:w-full mt-5 md:mt-20 p-5 flex justify-center">
            <div class="lg:w-[400px] xl:w-[500px]">
                <h1 class="text-3xl max-sm:text-2xl font-bold mb-5">Public Health Pesticides</h1>
                ...
                <a class="font-bold text-blue-500 hover:underline" href="/category/21">Learn More</a>
            </div>
        </div>
        <div class="w-[50%] h-[409px] max-sm:w-full">
            <img class="h-full w-full object-cover"
                src="{{asset('category/1742816722public_health.png')}}"
    ...
    <div
        ...
        <div class="product-data max-w-96 p-4 bg-gray-100 rounded-md shadow">
            <div class="relative w-full h-[200px] bg-cover bg-center mb-3 rounded-2xl"
                style="background-image: url('{{asset('subcategory/1744618299AgroChemicals.png')}}');">
                <div class="absolute top-0 right-0 p-4 bg-white/50 rounded-full">
                    <a href="/subcategory/25">

                    </a>
                </div>
            </div>
            <h2 class="text-2xl font-medium px-2 pb-2 h-16">General Pest Control</h2>
            ...
            <a href="/view/product-list.html?id=21&amp;subid=25"
        ...
        <div class="product-data max-w-96 p-4 bg-gray-100 rounded-md shadow">
            <div class="relative w-full h-[200px] bg-cover bg-center mb-3 rounded-2xl"
                style="background-image: url('{{asset('subcategory/1744618176public_health.png')}}');">
                <div class="absolute top-0 right-0 p-4 bg-white/50 rounded-full">
            ...
            <h2 class="text-2xl font-medium px-2 pb-2 h-16">Rodent Control</h2>
            <p class="px-2 pb-4 h-[134px] overflow-hidden text-zinc-500">Lorem ipsum dolor sit amet consectetur
                adipisicing elit. Reiciendis quam eos nemo, sunt at laudantium voluptatum eligendi, maxime aliquid
                voluptatem alias! Dolores cumque facere et!</p>
            <a href="/view/product-list.html?id=21&amp;subid=23"
                class="flex items-center justify-between p-2 bg-orange-500 text-white rounded-lg">
                <h3 class="pl-2 font-medium"><i class="ri-price-tag-3-fill text-orange-300 text-[27px]"></i> 3+ Products
                </h3>
            </a>
        </div>
        ...
        <div class="product-data max-w-96 p-4 bg-gray-100 rounded-md shadow">
            <div class="relative w-full h-[200px] bg-cover bg-center mb-3 rounded-2xl"
                style="background-image: url('{{asset('subcategory/1744618226manufacterstwo.png')}}');">
                <div class="absolute top-0 right-0 p-4 bg-white/50 rounded-full">
            ...
            <h2 class="text-2xl font-medium px-2 pb-2 h-16">Stored Grain Pest control</h2>
            <p class="px-2 pb-4 h-[134px] overflow-hidden text-zinc-500">Lorem ipsum dolor sit amet consectetur
                adipisicing elit. Reiciendis quam eos nemo, sunt at laudantium voluptatum eligendi, maxime aliquid
                voluptatem alias! Dolores cumque facere et!</p>
            <a href="/view/product-list.html?id=21&amp;subid=24"
                class="flex items-center justify-between p-2 bg-orange-500 text-white rounded-lg">
                <h3 class="pl-2 font-medium"><i class="ri-price-tag-3-fill text-orange-300 text-[27px]"></i> 2+ Products
                </h3>
            </a>
        </div>
        ...
        <div class="product-data max-w-96 p-4 bg-gray-100 rounded-md shadow">
            <div class="relative w-full h-[200px] bg-cover bg-center mb-3 rounded-2xl"
                style="background-image: url('{{asset('subcategory/1744618085picimage.png')}}');">
                <div class="absolute top-0 right-0 p-4 bg-white/50 rounded-full">
                    <a href="/subcategory/22">

                    </a>
                </div>
            </div>
            <h2 class="text-2xl font-medium px-2 pb-2 h-16">Termite Control</h2>
            <p class="px-2 pb-4 h-[134px] overflow-hidden text-zinc-500">Lorem ipsum dolor sit amet consectetur
                adipisicing elit. Reiciendis quam eos nemo, sunt at laudantium voluptatum eligendi, maxime aliquid
                voluptatem alias! Dolores cumque facere et!</p>
            <a href="/view/product-list.html?id=21&amp;subid=22"
                class="flex items-center justify-between p-2 bg-orange-500 text-white rounded-lg">
                <h3 class="pl-2 font-medium"><i class="ri-price-tag-3-fill text-orange-300 text-[27px]"></i> 3+ Products
                </h3>
            </a>
        ...
        <div class="product-data max-w-96 p-4 bg-gray-100 rounded-md shadow">
            <div class="relative w-full h-[200px] bg-cover bg-center mb-3 rounded-2xl"
                style="background-image: url('{{asset('subcategory/1744618025picimage.png')}}');">
                <div class="absolute top-0 right-0 p-4 bg-white/50 rounded-full">
            ...
            <h2 class="text-2xl font-medium px-2 pb-2 h-16">Vector Control</h2>
            <p class="px-2 pb-4 h-[134px] overflow-hidden text-zinc-500">Lorem ipsum dolor sit amet consectetur
                adipisicing elit. Reiciendis quam eos nemo, sunt at laudantium voluptatum eligendi, maxime aliquid
                voluptatem alias! Dolores cumque facere et!</p>
            <a href="/view/product-list.html?id=21&amp;subid=21"
                class="flex items-center justify-between p-2 bg-orange-500 text-white rounded-lg">
                <h3 class="pl-2 font-medium"><i class="ri-price-tag-3-fill text-orange-300 text-[27px]"></i> 3+ Products
                </h3>
            </a>
