...
<body class="bg-gray-100">
    <div class="flex h-screen">
        ...
        {{-- Main Content --}}
        <div class="main-content flex-1 p-6 ml-64 transition-all duration-300"> <!-- Page Heading -->
            <div class="bg-white p-6 mb-4 rounded-lg shadow-md">
                <h2 class="text-2xl font-bold">Menu Management</h2>
                <p class="text-gray-600 mt-2">Manage website navigation menus.</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-md"> <!-- Header -->
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-xl font-semibold">Menus List</h3> <a href="{{ route('admin.menus.create') }}"
                        class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600"> Add Menu </a>
                </div>
                        ...
                        <tbody>
                            @forelse ($menus as $menu)
                                <tr class="border-b hover:bg-gray-50 text-sm">
                                    ...
                                    <td class="py-2 px-4 capitalize"> {{ $menu->location }} </td>
                                    <td class="py-2 px-4 relative">
                                        <div class="relative dropdown inline-block text-left"> <button type="button"
                                            ...
                                            <div
                                                ...
                                                <div class="py-1"> <a
                                                        href="{{ route('admin.menus.edit', encrypt($menu->id)) }}"
                                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                                        Edit </a>
                                                    <div
                                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                                        <form
                                                            action="{{ route('admin.menus.destroy', encrypt($menu->id)) }}"
                                                            method="POST"
                                                            onsubmit="return confirm('Are you sure you want to delete this menu?');">
                                                            @csrf <input type="submit"
                                    ...
                                    <td colspan="5" class="py-4 text-center text-gray-500"> No menus found. </td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table> <!-- Pagination -->
