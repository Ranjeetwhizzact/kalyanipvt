                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        @if (isset($news->id))
                            <div class="col-span-2">
                                <label for="fileInput" class="block text-sm font-medium text-gray-700 mb-2">Upload
                                    photo</label>
                                <label for="fileInput">
                                    <img src="{{ $news->image ?? asset('backend/assests/img/article2.png') }}"
                        ...
                        <div class="mb-4 col-span-2 md:col-span-1">
                            ...
                            <select id="status" name="is_active"
                                value="{{ isset($news->is_active) ? $news->is_active : '' }}"
                                ...
                                <option {{ isset($news->is_active) && $news->is_active == 'active' ? 'selected' : '' }}>
                                    Active</option>
                                <option
                                    {{ isset($news->is_active) && $news->is_active == 'inactive' ? 'selected' : '' }}>
                                    Inactive
                                </option>
                            </select>
                        </div>
                        <div class="col-span-2 md:col-span-1">
                            ...
                            <input type="date" id="title" name="date"
                                value="{{ isset($news->date) ? $news->date : '' }}"
                                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Enter occupation" required />
                        </div>
                        <div class="col-span-2 md:col-span-1">
                            <label for="section_type" class="block text-sm font-medium text-gray-700 mb-2">Section
                                Type</label>
                            <input type="section_type" id="section_type" name="section_type"
                                value="{{ isset($news->section_type) ? $news->section_type : '' }}"
                                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Enter occupation" required />
                        </div>
                        <div class="col-span-2 md:col-span-1">
                        ...
                        <div class="col-span-2 md:col-span-1">
                            ...
                            <textarea id="description" name="description" value=""
                                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Enter description" rows="7" required>{{ isset($news->description) ? $news->description : '' }}</textarea>
                        </div>
