                ...
                <form action="{{url('storesubcategory')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div class="col-span-1">
                            ...
                            <div id="imageContainer">
                                <input type="file" name="img" id="fileInput" class="hidden" accept="image/*" required>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="mb-4 col-span-2 md:col-span-1">
                            ...
                            <select id="category_id" name="category_id"
                                ...
                                <option value="{{ $c->id }}" {{ isset($subcategory->category_id) &&
                        ...
                        <div class="col-span-2 md:col-span-1">
                            <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Short
                                Discription</label>
                            <textarea id="title" name="short_discription" value=""
                                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Enter product name" rows="7"
                                required> {{isset($subcategory->short_discription)?$subcategory->short_discription:''}}</textarea>
                        </div>
                        <div class="col-span-2 md:col-span-1">
                            <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Discription</label>
                            <textarea id="title" name="discription" value=""
                                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Enter product name" rows="7"
                                required> {{isset($subcategory->short_discription)?$subcategory->short_discription:''}}</textarea>
                        </div>
                        ...
                        <div class="mb-4 col-span-2 md:col-span-1">
                            ...
                            <select id="status" name="is_active"
                                ...
                                required>
                                <option value="" disabled selected>Select product status</option>
                                <option {{ isset($subcategory->is_active) && $subcategory->is_active == "active" ?
                                    'selected' : '' }}>Active</option>
                                <option {{ isset($subcategory->is_active) && $subcategory->is_active == "inactive" ?
