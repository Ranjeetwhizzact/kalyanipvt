    ...
    <div class="main-content flex-1 p-8 bg-gray-50 min-h-screen">
        <div class="max-w-3xl mx-auto">
            <div class="mb-8 flex justify-between items-center">
                ...
                <span
                    class="bg-blue-100 text-blue-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">Editor</span>
            </div>
                ...
                <form id="sectionForm" action="{{ route('sections.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div id="hero_fields" class="hidden space-y-5 animate-fadeIn">
                        <div class="grid grid-cols-1 gap-5">
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1">Hero Background Image <span
                                        class="text-red-500">*</span></label>
                                <div
                                    class="relative group border-2 border-gray-300 border-dashed rounded-xl p-4 transition-colors hover:border-blue-400 bg-gray-50">
                                    <input type="file" name="image_url" id="hero_image_input" accept="image/*"
                                    ...
                                    <div id="hero_preview_container"
                                        class="hidden relative rounded-lg overflow-hidden border">
                                        <img id="hero_preview" src="#" alt="Preview"
                    ...
                    <div id="section_fields" class="hidden space-y-5 animate-fadeIn">
                        <div>
                            ...
                            <input type="text" name="heading"
                                class="w-full border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 border">
                        </div>

                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-1">Description</label>
                            <textarea id="description" name="description" rows="3"
                                class="w-full border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 border"></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <img id="section_preview" src="#" alt="Preview"
                                    class="hidden h-16 w-16 object-cover rounded-lg border border-gray-200">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-6 border-t border-gray-100 flex items-center justify-end space-x-4">
                        <button type="button" onclick="resetForm()"
                            class="px-6 py-2.5 text-sm font-semibold text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
                            Cancel
                        </button>
                        <button type="submit"
