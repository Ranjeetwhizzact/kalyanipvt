                                ...
                                <div class="p-6">
                                    <div
                                        ...
                                        <div class="image-preview-container flex-shrink-0">
                                            <img src="{{ isset($blog->image) && $blog->image ? asset('storage/' . $blog->image) : 'https://placehold.co/600x400?text=Blog+Image' }}"
                                ...
                                <div class="p-6 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <textarea id="excerpt" name="summary" rows="3"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                            placeholder="Write a brief summary of your blog post">{{ old('excerpt', isset($blog->excerpt) ? $blog->excerpt : '') }}</textarea>
