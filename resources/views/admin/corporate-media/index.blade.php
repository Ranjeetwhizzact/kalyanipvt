    ...
    <div class="flex h-screen">
        ...
        <div class="main-content flex-1 p-6 ml-64 transition-all duration-300">
            ...
            <div class="bg-white p-6 mb-4 rounded-lg shadow-md">
                ...
                <h2 class="text-2xl font-bold">Corporate Media</h2>

                <p class="text-gray-600 mt-2">
                    Manage corporate videos and brochures.
                </p>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('admin.corporate-media.create') }}"
                    ...
                    <table class="min-w-full bg-white border border-gray-200">
                        ...
                        <thead>
                            ...
                            <tr class="bg-gray-200 text-gray-700 text-left text-sm">
                                ...
                                <th class="py-3 px-4 border-b">Media</th>
                            ...
                            @forelse ($media as $item)
                                <tr class="border-b hover:bg-gray-50 text-sm">
                                    ...
                                    <td class="py-2 px-4">
                                        ...
                                        @if ($item->type == 'video')
                                            <a href="{{ asset('storage/' . $item->video_url) }}" target="_blank"
                                        ...
                                        <div class="relative dropdown inline-block text-left">
                                            ...
                                            <div
                                                ...
                                                <div class="py-1">
                                                    ...
                                                    <a href="{{ route('admin.corporate-media.edit', encrypt($item->id)) }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <form
                                                            action="{{ route('admin.corporate-media.delete', encrypt($item->id)) }}"
                                                            method="POST"
