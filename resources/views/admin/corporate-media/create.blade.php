    ...
    <div class="flex h-screen">
        ...
        <div class="main-content flex-1 p-6 ml-64 transition-all duration-300">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md max-w-3xl mx-auto mt-10">
                ...
                <form action="{{ route('admin.corporate-media.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Video URL -->
                        <div id="videoField" class="md:col-span-2 hidden">
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Upload Video
                            </label>
                        ...
                        <!-- Brochure Upload -->
                        <div id="fileField" class="md:col-span-2 hidden">
