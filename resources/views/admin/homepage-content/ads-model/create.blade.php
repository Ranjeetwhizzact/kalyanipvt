        ...
        <div class="main-content flex-1 p-6 ml-64 transition-all duration-300">
            <div class="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto mt-10">
                ...
                <form
                    ...
                    <!-- Hidden ID field for controller logic -->
                    ...
                    <div class="mb-6">
                        ...
                        <input type="file"
                            ...
                            id="banner_image"
                            accept="image/*"
                            class="w-full px-4 py-2 border rounded-lg @error('banner') border-red-500 @enderror">
                        @error('banner')
                    ...
                    <div class="mb-6">
                        ...
                        <img id="imagePreview"
                            src="{{ isset($banner) && $banner->banner ? asset($banner->banner) : '' }}"
                            alt="Preview"
                            class="{{ isset($banner) && $banner->banner ? 'w-64 h-64 object-cover border rounded-lg shadow' : 'hidden w-64 h-64 object-cover border rounded-lg shadow' }}">
                    </div>
