                    ...
                    <div class="mb-6 border rounded-lg p-4 bg-gray-50">
                        ...
                        <div id="panel-remix">
                            <select name="icon_class" id="icon_class_select" class="w-full px-4 py-2 border rounded-lg">
                                ...
                                <option value="ri-facebook-circle-fill" {{ old('icon_class') == 'ri-facebook-circle-fill' ? 'selected' : '' }}>Facebook</option>
                                <option value="ri-instagram-fill"       {{ old('icon_class') == 'ri-instagram-fill'       ? 'selected' : '' }}>Instagram</option>
                                <option value="ri-linkedin-fill"        {{ old('icon_class') == 'ri-linkedin-fill'        ? 'selected' : '' }}>LinkedIn</option>
                                <option value="ri-youtube-fill"         {{ old('icon_class') == 'ri-youtube-fill'         ? 'selected' : '' }}>YouTube</option>
                                <option value="ri-twitter-x-fill"       {{ old('icon_class') == 'ri-twitter-x-fill'       ? 'selected' : '' }}>Twitter / X</option>
                                <option value="ri-whatsapp-fill"        {{ old('icon_class') == 'ri-whatsapp-fill'        ? 'selected' : '' }}>WhatsApp</option>
                                <option value="ri-telegram-fill"        {{ old('icon_class') == 'ri-telegram-fill'        ? 'selected' : '' }}>Telegram</option>
                                <option value="ri-pinterest-fill"       {{ old('icon_class') == 'ri-pinterest-fill'       ? 'selected' : '' }}>Pinterest</option>
                                <option value="ri-mail-line"            {{ old('icon_class') == 'ri-mail-line'            ? 'selected' : '' }}>Mail</option>
                            </select>
                        ...
                        <div id="panel-upload" class="hidden">
                            ...
                            <p class="text-xs text-gray-400 mt-1">If you upload a custom icon, the Remix Icon selection above will be ignored.</p>
                        </div>
                    </div>
                    ...
                    <div class="mb-6 border rounded-lg p-4 bg-orange-50">
                        ...
                        <div id="hp-panel-remix">
                            <select name="homepage_icon_class" id="hp_icon_class_select" class="w-full px-4 py-2 border rounded-lg">
                                <option value="">-- Select Icon --</option>
                                <option value="ri-facebook-circle-fill" {{ old('homepage_icon_class') == 'ri-facebook-circle-fill' ? 'selected' : '' }}>Facebook</option>
                                <option value="ri-instagram-fill"       {{ old('homepage_icon_class') == 'ri-instagram-fill'       ? 'selected' : '' }}>Instagram</option>
                                <option value="ri-linkedin-fill"        {{ old('homepage_icon_class') == 'ri-linkedin-fill'        ? 'selected' : '' }}>LinkedIn</option>
                                <option value="ri-youtube-fill"         {{ old('homepage_icon_class') == 'ri-youtube-fill'         ? 'selected' : '' }}>YouTube</option>
                                <option value="ri-twitter-x-fill"       {{ old('homepage_icon_class') == 'ri-twitter-x-fill'       ? 'selected' : '' }}>Twitter / X</option>
                                <option value="ri-whatsapp-fill"        {{ old('homepage_icon_class') == 'ri-whatsapp-fill'        ? 'selected' : '' }}>WhatsApp</option>
                                <option value="ri-telegram-fill"        {{ old('homepage_icon_class') == 'ri-telegram-fill'        ? 'selected' : '' }}>Telegram</option>
                                <option value="ri-pinterest-fill"       {{ old('homepage_icon_class') == 'ri-pinterest-fill'       ? 'selected' : '' }}>Pinterest</option>
                                <option value="ri-mail-line"            {{ old('homepage_icon_class') == 'ri-mail-line'            ? 'selected' : '' }}>Mail</option>
                            </select>
                            <div class="mt-3 flex items-center gap-3">
                                <span class="text-sm text-gray-500">Preview:</span>
