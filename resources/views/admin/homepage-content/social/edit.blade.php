...
<body class="bg-gray-100">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto mt-10">
                ...
                <form action="{{ route('admin.social.update', encrypt($social->id)) }}" method="POST"
                    ...
                    <div class="mb-6 border rounded-lg p-4 bg-gray-50">
                        <label class="block text-sm font-semibold mb-3 text-blue-700">Header Icon <span class="text-gray-400 font-normal text-xs">(shown in top black bar)</span></label>

                        <!-- Tab toggle -->
                        <div class="flex border rounded-lg overflow-hidden mb-4 w-fit">
                            <button type="button" id="tab-remix"
                                onclick="switchTab('remix')"
                        ...
                        <div id="panel-remix" class="{{ $hasUploadedIcon ? 'hidden' : '' }}">
                            <select name="icon_class" id="icon_class_select" class="w-full px-4 py-2 border rounded-lg">
                                ...
                                <option value="ri-facebook-circle-fill" {{ old('icon_class', $social->icon_class) == 'ri-facebook-circle-fill' ? 'selected' : '' }}>Facebook</option>
                                <option value="ri-instagram-fill"       {{ old('icon_class', $social->icon_class) == 'ri-instagram-fill'       ? 'selected' : '' }}>Instagram</option>
                                <option value="ri-linkedin-fill"        {{ old('icon_class', $social->icon_class) == 'ri-linkedin-fill'        ? 'selected' : '' }}>LinkedIn</option>
                                <option value="ri-youtube-fill"         {{ old('icon_class', $social->icon_class) == 'ri-youtube-fill'         ? 'selected' : '' }}>YouTube</option>
                                <option value="ri-twitter-x-fill"       {{ old('icon_class', $social->icon_class) == 'ri-twitter-x-fill'       ? 'selected' : '' }}>Twitter / X</option>
                                <option value="ri-whatsapp-fill"        {{ old('icon_class', $social->icon_class) == 'ri-whatsapp-fill'        ? 'selected' : '' }}>WhatsApp</option>
                                <option value="ri-telegram-fill"        {{ old('icon_class', $social->icon_class) == 'ri-telegram-fill'        ? 'selected' : '' }}>Telegram</option>
                                <option value="ri-pinterest-fill"       {{ old('icon_class', $social->icon_class) == 'ri-pinterest-fill'       ? 'selected' : '' }}>Pinterest</option>
                                <option value="ri-mail-line"            {{ old('icon_class', $social->icon_class) == 'ri-mail-line'            ? 'selected' : '' }}>Mail</option>
                            </select>
                            <div class="mt-3 flex items-center gap-3">
                                <span class="text-sm text-gray-500">Preview:</span>
                                <i id="icon_preview_class" class="{{ old('icon_class', $social->icon_class) }} text-2xl text-gray-700"></i>
                            </div>
                        </div>
                        ...
                        <div id="panel-upload" class="{{ $hasUploadedIcon ? '' : 'hidden' }}">
                            @if($social->icon)
                                <div class="mb-3 flex items-center gap-3">
                                    ...
                                    <img src="{{ asset($social->icon) }}" class="w-10 h-10 object-contain rounded border">
                                </div>
                            @endif
                            <input type="file" name="icon" id="icon" class="w-full border p-2 rounded" accept="image/*">
                            <div class="w-20 h-20 border mt-3 rounded bg-gray-100 flex items-center justify-center overflow-hidden">
                                <img id="icon_img_preview" class="hidden max-h-full max-w-full object-contain">
                            </div>
                            <p class="text-xs text-gray-400 mt-1">If you upload a custom icon, the Remix Icon selection will be ignored.</p>
                        </div>
                    </div>
                    ...
                    <div class="mb-6 border rounded-lg p-4 bg-orange-50">
                        <label class="block text-sm font-semibold mb-3 text-orange-700">Homepage Icon <span class="text-gray-400 font-normal text-xs">(shown in sticky side panel on homepage)</span></label>

                        <!-- Tab toggle -->
                        <div class="flex border rounded-lg overflow-hidden mb-4 w-fit">
                            <button type="button" id="hp-tab-remix"
                                onclick="switchHpTab('remix')"
                                class="px-4 py-2 text-sm font-medium {{ $hasUploadedHpIcon ? 'bg-white text-gray-700' : 'bg-orange-500 text-white' }} transition">
                                Remix Icon
                            </button>
                            <button type="button" id="hp-tab-upload"
                                onclick="switchHpTab('upload')"
                        ...
                        <div id="hp-panel-remix" class="{{ $hasUploadedHpIcon ? 'hidden' : '' }}">
                            <select name="homepage_icon_class" id="hp_icon_class_select" class="w-full px-4 py-2 border rounded-lg">
                                <option value="">-- Select Icon --</option>
                                <option value="ri-facebook-circle-fill" {{ old('homepage_icon_class', $social->homepage_icon_class) == 'ri-facebook-circle-fill' ? 'selected' : '' }}>Facebook</option>
                                <option value="ri-instagram-fill"       {{ old('homepage_icon_class', $social->homepage_icon_class) == 'ri-instagram-fill'       ? 'selected' : '' }}>Instagram</option>
                                <option value="ri-linkedin-fill"        {{ old('homepage_icon_class', $social->homepage_icon_class) == 'ri-linkedin-fill'        ? 'selected' : '' }}>LinkedIn</option>
                                <option value="ri-youtube-fill"         {{ old('homepage_icon_class', $social->homepage_icon_class) == 'ri-youtube-fill'         ? 'selected' : '' }}>YouTube</option>
                                <option value="ri-twitter-x-fill"       {{ old('homepage_icon_class', $social->homepage_icon_class) == 'ri-twitter-x-fill'       ? 'selected' : '' }}>Twitter / X</option>
                                <option value="ri-whatsapp-fill"        {{ old('homepage_icon_class', $social->homepage_icon_class) == 'ri-whatsapp-fill'        ? 'selected' : '' }}>WhatsApp</option>
                                <option value="ri-telegram-fill"        {{ old('homepage_icon_class', $social->homepage_icon_class) == 'ri-telegram-fill'        ? 'selected' : '' }}>Telegram</option>
                                <option value="ri-pinterest-fill"       {{ old('homepage_icon_class', $social->homepage_icon_class) == 'ri-pinterest-fill'       ? 'selected' : '' }}>Pinterest</option>
                                <option value="ri-mail-line"            {{ old('homepage_icon_class', $social->homepage_icon_class) == 'ri-mail-line'            ? 'selected' : '' }}>Mail</option>
                            </select>
                            <div class="mt-3 flex items-center gap-3">
                                <span class="text-sm text-gray-500">Preview:</span>
                                <i id="hp_icon_preview_class" class="{{ old('homepage_icon_class', $social->homepage_icon_class) }} text-2xl text-gray-700"></i>
                            </div>
                        </div>
                        ...
                        <div id="hp-panel-upload" class="{{ $hasUploadedHpIcon ? '' : 'hidden' }}">
                            @if($social->homepage_icon)
                                <div class="mb-3 flex items-center gap-3">
                                    <span class="text-sm text-gray-500">Current:</span>
                                    <img src="{{ asset($social->homepage_icon) }}" class="w-10 h-10 object-contain rounded border">
                                </div>
                            @endif
                            <input type="file" name="homepage_icon" id="homepage_icon" class="w-full border p-2 rounded" accept="image/*">
                            <div class="w-20 h-20 border mt-3 rounded bg-gray-100 flex items-center justify-center overflow-hidden">
    ...
    <script>
        ...
        function switchTab(tab) {
            ...
            document.getElementById('tab-remix').className  = 'px-4 py-2 text-sm font-medium transition ' + (isRemix  ? 'bg-blue-500 text-white' : 'bg-white text-gray-700');
            document.getElementById('tab-upload').className = 'px-4 py-2 text-sm font-medium transition ' + (!isRemix ? 'bg-blue-500 text-white' : 'bg-white text-gray-700');
            if (isRemix) {
        ...
        function switchHpTab(tab) {
            ...
            document.getElementById('hp-tab-remix').className  = 'px-4 py-2 text-sm font-medium transition ' + (isRemix  ? 'bg-orange-500 text-white' : 'bg-white text-gray-700');
            document.getElementById('hp-tab-upload').className = 'px-4 py-2 text-sm font-medium transition ' + (!isRemix ? 'bg-orange-500 text-white' : 'bg-white text-gray-700');
            if (isRemix) {
