    ...
    <div class="flex h-screen">
        ...
        <div class="main-content flex-1 p-6 ml-64 transition-all duration-300">
            <div class="bg-white p-6 rounded-lg shadow-md max-w-3xl mx-auto mt-10">
                ...
                <!-- Form -->
                <form action="{{ route('admin.menu-items.update', encrypt($menuItem->id)) }}" method="POST">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <select name="page_id"
                                ...
                                @foreach ($pages as $page)
                                    <option value="{{ $page->id }}"
                                        {{ $menuItem->page_id == $page->id ? 'selected' : '' }}>
                                        {{ $page->title }}
                                    </option>
                                @endforeach
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="status"
                                ...
                                <option value="active" {{ $menuItem->status == 'active' ? 'selected' : '' }}>
                                    Active
                                </option>

                                <option value="inactive" {{ $menuItem->status == 'inactive' ? 'selected' : '' }}>
                                    Inactive
                                </option>
