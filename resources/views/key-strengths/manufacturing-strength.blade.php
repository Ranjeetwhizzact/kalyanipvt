...
@section('title', 'Manufacturing Strength - Kalyani Industries Limited')
@section('styles')
@endsection
@section('content')
    ...
    <section class="w-full">
        <div class="w-full h-96 lg:h-[518px] relative overflow-hidden">
            <img src="{{ asset('banner/manufacturing-strength.png') }}" alt="" srcset=""
            ...
            <div class="w-full lg:w-1/2 h-full absolute top-0 left-0 z-20 flex justify-center items-end lg:items-center">
                <div class="w-full md:w-[550px] ">
                    <h5 class=" text-2xl md:text-3xl xl:text-5xl text-orange-500  font-poppins px-2 mb-10">Innovative
                        Manufacturing for a Sustainable Future</h5>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="w-full my-16">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-7">
            <div class="px-2 sm:px-3 lg:px-0"><img src="{{ asset('banner/agrochemical.png') }}" alt=""
                    srcset="" class="max-h-[80vh] w-full object-cover rounded-md lg:rounded-e-md lg:rounded-s-none">
            </div>

            <div class="flex items-center justify-center">
                <div class="lg:w-[501px] px-4 lg:px-0">
                    <h2 class="text-3xl md:text-[40px] md:leading-[50px] font-inter">Our advanced manufacturing units
                        utilize automated production lines that prioritize eco-friendly processes. Experience the perfect
                        blend of precision and sustainability in every product we create</h2>

                    <!-- <p class="text-base text-gray-600 font-inter my-7">Partnering with Kalyani grants you exclusive territorial rights, empowering you to dominate your market. Our comprehensive marketing support and training ensure you have the tools needed for success.</p> -->
    ...
    <section class="w-full relative h-96 my-5">
        <div class="swiper w-full h-full mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide text-center text-lg bg-white flex justify-center items-center"><img
                        src="{{ asset('banner/manufacturone.png') }}" class="w-full h-full block object-cover"
                        alt=""></div>
                <div class="swiper-slide text-center text-lg bg-white flex justify-center items-center"><img
                        src="{{ asset('banner/manufacturone.png') }}" class="w-full h-full block object-cover"
                        alt=""></div>
