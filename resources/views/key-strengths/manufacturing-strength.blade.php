...
<section class="w-full my-16">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-7">
        ...
        <div class="px-2 sm:px-3 lg:px-0 order-1 lg:order-2"><img src="{{ asset('banner/manfactuerthree.png') }}" alt=""
                srcset="" class="max-h-[80vh] w-full object-cover rounded-md lg:rounded-e-md lg:rounded-s-none"></div>
